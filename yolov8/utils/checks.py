...
from yolov8.utils import (ASSETS, AUTOINSTALL, LINUX, LOGGER, ONLINE, ROOT, USER_CONFIG_DIR, SimpleNamespace,
...
def check_pip_update_available():
    ...
    if ONLINE and is_pip_package():
        with contextlib.suppress(Exception):
            from yolov8 import __version__
...
def collect_system_info():
    ...
    from yolov8.utils import ENVIRONMENT, is_git_dir
    from yolov8.utils.torch_utils import get_cpu_info
