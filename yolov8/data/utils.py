...
from yolov8.utils import (DATASETS_DIR, LOGGER, NUM_THREADS, ROOT, SETTINGS_YAML, TQDM, clean_url, colorstr,
                               emojis, yaml_load, yaml_save)
from yolov8.utils.checks import check_file, check_font, is_ascii
from yolov8.utils.downloads import download, safe_download, unzip_file
from yolov8.utils.ops import segments2boxes
...
class HUBDatasetStats:
    ...
    def get_json(self, save=False, verbose=False):
        ...
        for split in 'train', 'val', 'test':
            ...
            if self.task == 'classify':
                ...
                from yolov8.data import YOLODataset
    ...
    def process_images(self):
        ...
        from yolov8.data import YOLODataset  # ClassificationDataset
